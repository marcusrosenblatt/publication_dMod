...
Each transportation process is modeled by mass-action kinetics. A possible implementation in \pkg{dMod} is as follows:
\begin{CodeChunk}
	\begin{CodeInput}
# Add reactions
reactions <- NULL
